...
namespace _2.data_types
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(string.Format("Тип {0,8} |\t.NET {1,8} |\tРазмер = {2}", "string", typeof(string).Name, "N/A"));

            Console.WriteLine("\n\t\t\t\t\t\tЛОГИЧЕСКИЙ ТИП:\n");

            Console.WriteLine(string.Format("Тип {0,8} |\t.NET {1,8} |\tРазмер = {2}", "bool", typeof(bool).Name, sizeof(bool)));

            Console.WriteLine("\n\t\t\t\t\t\tОСОБЫЕ ТИПЫ:\n");

            Console.WriteLine(string.Format("Тип {0,8} |\t.NET {1,8} |\tРазмер = {2}", "object", typeof(object).Name, "N/A"));
            Console.WriteLine(string.Format("Тип {0,8} |\t.NET {1,8} |\tРазмер = {2}", "dynamic", "dynamic", "N/A"));
